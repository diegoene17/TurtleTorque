...
bool TurtleTorque3MotorDriver::writeCurrent(int32_t left_value, int32_t right_value)
{
  ...
  DEBUG.println("Valor izquiero: %i %i",left_data_byte[1],left_data_byte[0]);
