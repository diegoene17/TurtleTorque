...
#include "../../include/turtlebot3/turtlebot3_torque_driver.h"

Turtlebot3TorqueDriver::Turtlebot3TorqueDriver()
: baudrate_(BAUDRATE),
...
bool Turtlebot3TorqueDriver::init(String turtlebot3)
{
...
bool Turtlebot3TorqueDriver::setTorque(bool onoff)
{
  uint8_t dxl_error = 0;
...
bool Turtlebot3TorqueDriver::getTorque()
{
  return torque_;
}

void Turtlebot3TorqueDriver::close(void)
{
...
bool Turtlebot3TorqueDriver::readEncoder(int32_t &left_value, int32_t &right_value)
{
...
bool Turtlebot3TorqueDriver::writeVelocity(int64_t left_value, int64_t right_value)
{
...
bool Turtlebot3TorqueDriver::controlMotor(const float wheel_radius, const float wheel_separation, float* value)
{
